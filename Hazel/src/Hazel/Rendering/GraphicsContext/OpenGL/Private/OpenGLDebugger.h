...
namespace Hazel
{
	...
	{
	private:
		static inline const std::unordered_map<GLenum, std::string> sources = {
		...
		static inline const std::unordered_map<GLenum, std::string> types = {
		...
		static inline const std::unordered_map<GLenum, std::string> severities = {
