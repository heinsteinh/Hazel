...
namespace Hazel
{
	...
	public:
		...
		virtual std::shared_ptr<InputLayout> CreateInputLayout(const VertexLayout &vertexAttributes) override;
		...
		virtual size_t GetUniformBufferBindingCount() override;
		virtual void SetUniformBuffer(UniformBuffer *constantBuffer, size_t binding = 0) override;
