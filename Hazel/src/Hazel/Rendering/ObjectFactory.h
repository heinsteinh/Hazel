...
namespace Hazel
{
    ...
    public:
        ...
        virtual SharedPtr<Shader> CreateShader(const std::string &name, const std::string &vertexSource, const std::string &fragmentSource) = 0;
        virtual SharedPtr<Shader> CreateShader(const std::string &name, const std::string &filename) = 0;
