...
namespace Hazel
{
    ...
    public:
        ...
        virtual void Put(const std::string &name, float value) = 0;
        virtual void Put(const std::string &name, const glm::vec2 &value) = 0;
        ...
        virtual void Put(const std::string &name, const glm::mat3 &value) = 0;
