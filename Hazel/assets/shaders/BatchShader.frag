...
void main()
{
	...
	switch (v_TextureIndex)
	{
		case 0:
			...
			break;
		case 1: 
			o_Color *= texture(u_Texture1, v_TextureCoordinate);
			break;
		case 2: 
			o_Color *= texture(u_Texture2, v_TextureCoordinate);
			break;
		case 3: 
			o_Color *= texture(u_Texture3, v_TextureCoordinate);
			break;
		case 4: 
			o_Color *= texture(u_Texture4, v_TextureCoordinate);
			break;
		case 5: 
			o_Color *= texture(u_Texture5, v_TextureCoordinate);
			break;
		case 6: 
			o_Color *= texture(u_Texture6, v_TextureCoordinate);
			break;
		case 7: 
			o_Color *= texture(u_Texture7, v_TextureCoordinate);
			break;
		case 8: 
			o_Color *= texture(u_Texture8, v_TextureCoordinate);
			break;
		case 9: 
			o_Color *= texture(u_Texture9, v_TextureCoordinate);
			break;
		case 10:
			o_Color *= texture(u_Texture10, v_TextureCoordinate);
			break;
		case 11:
			o_Color *= texture(u_Texture11, v_TextureCoordinate);
			break;
		case 12:
			o_Color *= texture(u_Texture12, v_TextureCoordinate);
			break;
		case 13:
			o_Color *= texture(u_Texture13, v_TextureCoordinate);
			break;
		case 14:
			o_Color *= texture(u_Texture14, v_TextureCoordinate);
			break;
		case 15:
			o_Color *= texture(u_Texture15, v_TextureCoordinate);
			break;
		case 16:
			o_Color *= texture(u_Texture16, v_TextureCoordinate);
			break;
		case 17:
			o_Color *= texture(u_Texture17, v_TextureCoordinate);
			break;
		case 18:
			o_Color *= texture(u_Texture18, v_TextureCoordinate);
			break;
		case 19:
			o_Color *= texture(u_Texture19, v_TextureCoordinate);
			break;
		case 20:
			o_Color *= texture(u_Texture20, v_TextureCoordinate);
			break;
		case 21:
			o_Color *= texture(u_Texture21, v_TextureCoordinate);
			break;
		case 22:
			o_Color *= texture(u_Texture22, v_TextureCoordinate);
			break;
		case 23:
			o_Color *= texture(u_Texture23, v_TextureCoordinate);
			break;
		case 24:
			o_Color *= texture(u_Texture24, v_TextureCoordinate);
			break;
		case 25:
			o_Color *= texture(u_Texture25, v_TextureCoordinate);
			break;
		case 26:
			o_Color *= texture(u_Texture26, v_TextureCoordinate);
			break;
		case 27:
			o_Color *= texture(u_Texture27, v_TextureCoordinate);
			break;
		case 28:
			o_Color *= texture(u_Texture28, v_TextureCoordinate);
			break;
		case 29:
			o_Color *= texture(u_Texture29, v_TextureCoordinate);
			break;
		case 30:
			o_Color *= texture(u_Texture30, v_TextureCoordinate);
			break;
		case 31:
			o_Color *= texture(u_Texture31, v_TextureCoordinate);
			break;
	}
}